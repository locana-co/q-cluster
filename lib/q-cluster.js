...
var QCluster = (function(module){
    ...
    module.PointClusterer.prototype.setReportingPropertyColor = function(reportingPropertyName, color) {
    	var property = this.reportingDictionary[reportingPropertyName];
    	if (!property) return;
    	property.color = color;
    };

    module.PointClusterer.prototype.setReportingPropertyLabel = function(reportingPropertyName, label) {
    	var property = this.reportingDictionary[reportingPropertyName];
    	if (!property) return;
    	property.label = label;
    };

    module.PointClusterer.prototype.addReportingPropertyDictionary = function(dictionary) {
    	if (!this.reportingDictionary) this.reportingDictionary = {};
    	$.extend(this.reportingDictionary, dictionary);
    	// older projects may use alternate names for color and label (like FSP)
    	var keys = Object.keys(this.reportingDictionary);
    	keys.forEach(function(key){
    		var color = this.reportingDictionary[key].ClusterColor
